        ...
        <div className="container flex flex-col items-center gap-13 md:flex-row-reverse md:justify-between">
          ...
          <div className="sm:text-center md:text-left">
            ...
            <p className="mt-3 xl:text-[17px] 3xl:text-lg sm:max-w-[600px] md:max-w-[485px] xl:max-w-[530px] 3xl:max-w-[550px]">
              I design and develop user-friendly web and mobile solutions that are fast, responsive, secure, and work
              seamlessly across all devices. I transform your ideas into reality with clean, efficient code.
            </p>
          ...
          <div className="mx-3 text-center grid gap-8 md:grid-cols-2 3xl:gap-16">
            ...
            <div className="card-animation flex-center relative p-[3px] rounded-2xl overflow-hidden transition-300">
              ...
              >
                ...
                <p className="font-medium text-sm xl:text-base 3xl:text-[17px]">
                  I have over 6 years of experience in web and mobile development, working with both front-end and
                  back-end technologies like HTML, CSS, JavaScript, React, Tailwind CSS, Node.js, Express.js, MongoDB,
                  Next.js, React Native and more. I'm passionate about staying updated with the latest trends and
                  continuously expanding my skill set to deliver innovative solutions.
                </p>
            ...
            <div className="card-animation flex-center relative p-[3px] rounded-2xl overflow-hidden transition-300">
              ...
              >
                ...
                <p className="font-medium text-sm xl:text-base 3xl:text-[17px]">
                  I create high-performance, responsive web and mobile solutions for many industries including business
                  services, online stores, portfolios, corporate websites, blogs, one-page sites, restaurants, events,
                  and more. By focusing on each client's unique needs, I deliver projects that boost engagement and help
